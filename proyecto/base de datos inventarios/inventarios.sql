...
INSERT INTO detalle VALUES('5','Entrada','PRO01','BOD02','EMP03','FAC01');
...
--triggers
------------------------------------------------
create trigger tr_aumentarproducto
on detalle
after insert
as
...
where id_producto=@id_producto and tipo_det=@tipo_det and tipo_det='Entrada'
